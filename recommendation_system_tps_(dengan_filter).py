# -*- coding: utf-8 -*-
"""Recommendation_System_TPS_(dengan_filter).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ylpj3nZiTT4uklS-VDIoghkoUEDSNNRJ
"""
...
def get_mistakes_per_category(user_data):
    mistakes = user_data[user_data['USER_ANSWER']
...
def recommend_questions_for_user(user_id, user_history, tps_question_data, last_questions, total_questions=10):
    if is_new_user(user_id, user_history):
        ...
        proportion = determine_proportion(
        ...
        quiz_questions = generate_quiz_avoiding_repeats(
            proportion, top_similar_questions, mistakes, tps_question_data_filtered, last_questions, total_questions)
...
last_questions = recommend_questions_for_user(
    user_id, user_history, tps_question_data, last_questions)
